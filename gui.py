...
class GrowOrganicGUI(tk.Tk):
    ...
    def __init__(self):
        ...
        self.calendar_widget = Calendar(self,font="Arial 14", selectmode='day',cursor="hand1", year=2020, month=10, day=5)
    ...
    def scheduleEvent(self):
        print(f"Scheduling {self.event_type.get()} event on {self.calendar_widget.selection_get()} at {self.event_time.get()}")
